...
class Stage_08(Stage):
    def __init__(self, space, screen):

        super().__init__(space, screen)
        # obsticles
        self.ob = obstacles.Obsticle(800.0, 700, 140, 512, 0, 5)
        space.add(self.ob.body, self.ob.shape)

        # obsticles
        self.ob2 = obstacles.Obsticle(400.0, 160, 140, 512, 0, 5)
        ...
        # # bricks
        self.brick_1 = Brick(1000, 400, 64, 64,340, 3)
    ...
    def update(self, screen):
        rec = self.scaled_img.get_rect(center = (800, 700))
        screen.blit(self.scaled_img, rec)

        rec2 = self.scaled_img.get_rect(center = (400, 160))
        screen.blit(self.scaled_img, rec2)
